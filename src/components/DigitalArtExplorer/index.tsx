import DigitalArtExplorerItem from './DigitalArtExplorerItem';
import DigitalArtExplorerRankItem from './DigitalArtExplorerRankItem';
    ...
    <div className="cont2Bg">
      ...
      <div className="contInner">
        <div className="top3cont">
          ...
          {auctions.map((item, i) => (
            i < 3 && <DigitalArtExplorerItem key={i} {...item} />
          ))}
        </div>
      </div>
    </div>
